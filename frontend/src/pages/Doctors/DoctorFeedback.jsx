  ...
  return (
    <div>
        <div className="mb-[50px]">
            <h4 className="text-[20px] leading-3 font-bold text-headingColor mb-[30px]">All reviews ({totalRating})</h4>
           ...
           <div key={index} className="flex justify-between gap-10 mb-[30px]">
            <div className="flex gap-3">
                ...
                <div>
                    ...
                    <p className="text-[14px] leading-6 text-textColor">{FormatedDate(review?.createdAt)}</p>
