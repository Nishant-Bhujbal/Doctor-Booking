        ...
        <div className="grid md:grid-cols-3 gap-[50px]">
            <div className="md:col-span-2">
                <div className="flex items-center gap-5">
                    <figure className="max-w-[200px] msx-h-[200px]">
                    ...
                    <div>
                      ...
                      <h3 className="text-headingColor text-[22px] leading-9 mt-3 font-bold">Nishant Bhujbal</h3>
                      ...
                      <p className="text__para text-[14px] leading-6 md:text-[15px] lg:max-w-[390px]">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Velit, facilis adipisci, natus ad excepturi.</p>
                    </div>
                </div>
